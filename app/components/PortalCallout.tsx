    ...
    <section className="w-full bg-[#f8fafc] dark:bg-[#09090b] px-4 sm:px-6 md:px-10 lg:px-12 py-10 sm:py-16 md:py-20 transition-colors duration-200">
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#a500a3] via-[#680097] to-[#3b0764] text-white p-6 sm:p-10 md:p-16 text-center flex flex-col items-center gap-5 sm:gap-6 shadow-2xl">
          ...
          <h2 className="relative z-10 text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold max-w-5xl leading-[1.15] tracking-tight">
            Whether you&apos;re an investor, trader, merchant, or learner there is a place for you inside our ecosystem.
          </h2>

          <p className="relative z-10 text-sm sm:text-base md:text-lg text-purple-100 max-w-3xl leading-relaxed">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto pt-2">
            <a
              ...
              className="bg-white hover:bg-zinc-100 text-[#680097] font-bold text-sm sm:text-base px-9 py-3.5 rounded-full shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 w-full sm:w-auto active:scale-95"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/10 hover:bg-white/20 text-white border border-white/30 font-bold text-sm sm:text-base px-9 py-3.5 rounded-full transition-all flex items-center justify-center gap-2 w-full sm:w-auto backdrop-blur-xs active:scale-95"
            >
